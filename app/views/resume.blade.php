    ...
    <div class="container">
      <div class="page-header">
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <address>
              <p class="text-left"><strong>Orlando Villaseñor</strong><br>
              <a href="mailto: orlandovillasenor@me.com">orlandovillasenor@me.com</a>
            </address>
          </div>
          <div class="col-md-2">
            <p class="text-left"> <a href="http://linkedin.com/in/orlandovillasenor/" target="_blank"> <i class="fa fa-linkedin-square fa-lg"></i> Linkedin</a> <br>
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <p><strong>Everlong Recording Company, San Antonio, TX</strong><br><em>Owner - Recording/Mix Engineer</em></p>
            <ul>
            ...
            <p><strong>GMR Painting, LLC, San Antonio, TX</strong><br><em>Operations Manager</em></p>
            <ul>
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <address>
              <strong>University of Texas at Austin</strong><br>
              Economics<br>
              Austin, TX<br>
            </address>
            <address>
              <strong>Austin Community College</strong><br>
